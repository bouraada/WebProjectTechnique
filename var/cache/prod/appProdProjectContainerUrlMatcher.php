...
class appProdProjectContainerUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($rawPathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/user')) {
            ...
            // userProfil
            if (0 === strpos($pathinfo, '/user/profil') && preg_match('#^/user/profil/(?P<iduser>[^/]++)$#sD', $pathinfo, $matches)) {
            ...
            if (0 === strpos($pathinfo, '/user/m')) {
                // userMesPerformances
                if ('/user/mesperformances' === $pathinfo) {
                    return array (  '_controller' => 'AppBundle\\Controller\\UserController::PerformancesAction',  '_route' => 'userMesPerformances',);
                }

                // userMesSeances
                if ('/user/messeances' === $pathinfo) {
                    return array (  '_controller' => 'AppBundle\\Controller\\UserController::MesSeancesAction',  '_route' => 'userMesSeances',);
                }
            ...
            // userPresentationProgramme
            if (0 === strpos($pathinfo, '/user/ficheprogramme') && preg_match('#^/user/ficheprogramme/(?P<nom>[^/]++)$#sD', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'userPresentationProgramme')), array (  '_controller' => 'AppBundle\\Controller\\UserController::PresentationProgrammeAction',));
            }
