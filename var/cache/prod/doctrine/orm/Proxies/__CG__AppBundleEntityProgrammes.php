 ...
 */
class Programmes extends \AppBundle\Entity\Programmes implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Programmes' . "\0" . 'titre', '' . "\0" . 'AppBundle\\Entity\\Programmes' . "\0" . 'description', '' . "\0" . 'AppBundle\\Entity\\Programmes' . "\0" . 'statut', '' . "\0" . 'AppBundle\\Entity\\Programmes' . "\0" . 'idProg', '' . "\0" . 'AppBundle\\Entity\\Programmes' . "\0" . 'idUser'];
        }
    ...
    public function getIdProg()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getIdProg();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIdProg', []);

        return parent::getIdProg();
    }
