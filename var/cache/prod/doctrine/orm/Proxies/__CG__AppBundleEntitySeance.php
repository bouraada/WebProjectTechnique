 ...
 */
class Seance extends \AppBundle\Entity\Seance implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Seance' . "\0" . 'debut', '' . "\0" . 'AppBundle\\Entity\\Seance' . "\0" . 'fin', '' . "\0" . 'AppBundle\\Entity\\Seance' . "\0" . 'statut', '' . "\0" . 'AppBundle\\Entity\\Seance' . "\0" . 'idSea', '' . "\0" . 'AppBundle\\Entity\\Seance' . "\0" . 'idUser'];
        }
    ...
    public function getIdSea()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getIdSea();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIdSea', []);

        return parent::getIdSea();
    }
