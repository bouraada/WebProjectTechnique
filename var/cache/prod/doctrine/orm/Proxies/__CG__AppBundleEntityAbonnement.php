 ...
 */
class Abonnement extends \AppBundle\Entity\Abonnement implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Abonnement' . "\0" . 'titre', '' . "\0" . 'AppBundle\\Entity\\Abonnement' . "\0" . 'type', '' . "\0" . 'AppBundle\\Entity\\Abonnement' . "\0" . 'prix', '' . "\0" . 'AppBundle\\Entity\\Abonnement' . "\0" . 'idAbo', '' . "\0" . 'AppBundle\\Entity\\Abonnement' . "\0" . 'idUser'];
        }
