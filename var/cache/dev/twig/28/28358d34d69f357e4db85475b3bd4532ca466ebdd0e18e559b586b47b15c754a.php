...
class __TwigTemplate_9e74b251ea6940a7bdbcefff3560f5edea1da648efa9a7835599d92dc21215f7 extends Twig_Template
{
    public function __construct(Twig_Environment $env)
    {
        ...
        // line 1
        $this->parent = $this->loadTemplate("BaseAdmin.html.twig", "Admin/Dashboard.html.twig", 1);
        $this->blocks = array(
    ...
    <div class=\"row\">
        <div class=\"col-lg-12\">
            <h1 class=\"page-header\" style=\"color: #b00000\">Bienvenue<span> ";
        // line 8
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["seance"]) {
            ...
            if ((twig_date_format_filter($this->env, "now", "Y-m-d") < twig_date_format_filter($this->env, $this->getAttribute($context["seance"], "debut", array()), "Y-m-d"))) {
                ...
                echo " </td>                                                    
                                                    <td>";
                // line 50
                echo twig_escape_filter($this->env, twig_date_format_filter($this->env, $this->getAttribute($context["seance"], "debut", array()), "H:n"), "html", null, true);
                echo " </td>
                                                    <td>";
                // line 51
...
", "Admin/Dashboard.html.twig", "/Applications/MAMP/htdocs/Finale/coachme/app/Resources/views/Admin/Dashboard.html.twig");
    }
}
